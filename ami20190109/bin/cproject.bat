...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="cproject" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" org.contentmine.cproject.files.CProject %CMD_LINE_ARGS%
