...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="ami-pixel" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" org.contentmine.ami.tools.AMIPixelTool %CMD_LINE_ARGS%
