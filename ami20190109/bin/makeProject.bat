...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="makeProject" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" org.contentmine.cproject.files.MakeProject %CMD_LINE_ARGS%
