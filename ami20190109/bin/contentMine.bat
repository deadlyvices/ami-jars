...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="contentMine" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" org.contentmine.ContentMine %CMD_LINE_ARGS%
