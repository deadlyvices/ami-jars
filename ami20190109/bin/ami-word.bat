...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="ami-word" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" org.contentmine.ami.plugins.word.WordPlugin %CMD_LINE_ARGS%
