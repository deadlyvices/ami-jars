...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="ami-sequence" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" org.contentmine.ami.plugins.sequence.SequencePlugin %CMD_LINE_ARGS%
